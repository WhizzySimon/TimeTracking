...
├── TempAppDevDocs/Features/Specs/ (Phase specs: P01, P06, P07)
├── TempAppDevDocs/Features/Plans/ (Phase plans: P01, P06, P07)
├── TempAppDevDocs/Features/Tasks/ (Phase tasks: P01, P06, P07)
...
3. **Phase numbering gaps** — Phase 6 exists but no Phase 0 spec. Evidence: TempAppDevDocs/Features/Specs/ contains P01, P06, P07 but no P00, P02-P05.
...
8. **Spec template not enforced** — TempAppDevDocs/Features/Specs/\_template.md exists but no validation. Evidence: Some specs missing sections (e.g., "Data & privacy notes").
...
- **Smallest change:** Add checklist to TempAppDevDocs/Features/Specs/\_template.md footer with all required sections
- **Where:** `TempAppDevDocs/Features/Specs/_template.md`
