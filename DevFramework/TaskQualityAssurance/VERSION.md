...
This version tracks the **Autonomy Stack framework** (DevFramework/TaskQualityAssurance/, scripts/CascadeAgentTools/), NOT the TimeTracker app.
...
2. Add entry to `DevFramework/TaskQualityAssurance/CHANGELOG.md`
