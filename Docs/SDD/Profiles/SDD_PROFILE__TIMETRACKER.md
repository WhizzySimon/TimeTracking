...
- `Docs/Guidelines/IMPLEMENTATION_SPECIFICATION_RULES.md` — FR/IG/DD writing rules
- `Docs/Guidelines/DEVELOPMENT_GUIDELINES.md` — PWA development rules
...
2. **FR/IG/DD numbering** — All requirements numbered and testable (`Docs/Guidelines/IMPLEMENTATION_SPECIFICATION_RULES.md:19-48`)
...
9. **Conventional commits** — Enforced format: `feat:`, `fix:`, `refactor:`, etc. (`Docs/Guidelines/SPEC_DRIVEN_DEVELOPMENT.md:215-232`)
...
4. **Document devlog format** — Target: `Docs/Guidelines/DEVLOG_FORMAT.md` explain tag validation rules
...
8. **Standardize language** — Target: All `Docs/Guidelines/*.md` use English consistently
9. **Add token tracking** — Target: `Docs/Guidelines/COST_TRACKING.md` document token usage per session
