...
- static/sw.js → static/sw.template.js — renamed, added BUILD_ID marker line at top — Evidence: "Rename static/sw.js to static/sw.template.js (keep content identical) and ensure the first line is: // __BUILD_ID__ = "dev""
...
- scripts/update-version.js — extended to read sw.template.js, replace BUILD_ID marker, write sw.js — Evidence: "Update scripts/update-version.js: Read static/sw.template.js, replace the marker line with: // __BUILD_ID__ = "<version>-<buildTime>""
...
- static/sw.template.js — exists with BUILD_ID marker on line 1 — Evidence: read_file showed "// __BUILD_ID__ = "dev"" at line 1
