...
1. Add a “Harness” concept to `Docs/DevFramework/DeveloperGuidesAndStandards/SPEC_DRIVEN_DEVELOPMENT.md` (what artifacts must exist so future chats start fast).
