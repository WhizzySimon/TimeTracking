...
1. Add a small “Evals mindset” section to `Docs/DevFramework/DeveloperGuidesAndStandards/SPEC_DRIVEN_DEVELOPMENT.md` (treat acceptance checks like an eval suite).
