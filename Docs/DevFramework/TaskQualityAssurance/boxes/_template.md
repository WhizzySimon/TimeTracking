...
- [ ] Evidence Bundle created and **staged** (`Docs/DevFramework/DevFramework/FrameworkSelfImprovementLogs
/Evidence/<task-id>.md`)
...
**Model switch behavior** (see `Docs/DevFramework/DevFramework/JustInTimeAgentRules
/ai-config.json`):
