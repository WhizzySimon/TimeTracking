...
6. **Add domain prefix convention** — Target: `Docs/DevFramework/DeveloperGuidesAndStandards/IMPLEMENTATION_SPECIFICATION_RULES.md` document domain prefix convention (e.g., V2UI, V2EP)
7. **Add spec length guidelines** — Target: `Docs/DevFramework/DeveloperGuidesAndStandards/IMPLEMENTATION_SPECIFICATION_RULES.md` add "small: ~500 lines, medium: ~1000 lines, complex: ~2500 lines"
8. **Add ASCII UI diagram convention** — Target: `Docs/DevFramework/DeveloperGuidesAndStandards/IMPLEMENTATION_SPECIFICATION_RULES.md` document component boundary diagrams
