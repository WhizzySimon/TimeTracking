...
- **Flag location:** `Docs/DevFramework/DevFramework/JustInTimeAgentRules/ai-config.json`
...
```
Docs/DevFramework/DevFramework/FrameworkSelfImprovementLogs/Evidence/AUD-YYYY-MM-DD-01.md
```
...
- PASS if present
- FAIL if missing → Remediation: Create from `Docs/DevFramework/DevFramework/FrameworkSelfImprovementLogs/Evidence/_template.md` and stage it
