...
**Purpose:** Extract _process_ practices that may not be visible in repo structure, mapped to our 10-axis rubric.
...
2. **Design endpoints to serve both developers _and_ the agent**
