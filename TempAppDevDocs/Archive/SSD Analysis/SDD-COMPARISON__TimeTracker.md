...
├── Create: TempAppDevDocs/Features/Specs/<feature-slug>.md
...
Phase 2: PLAN (how)
├── Create: TempAppDevDocs/Features/Plans/<feature-slug>.md
...
├── Create: TempAppDevDocs/Features/Tasks/<feature-slug>.md
...
| **Separation of spec/plan/tasks**        |`TempAppDevDocs/Features/Specs/`, `TempAppDevDocs/Features/Plans/`, `TempAppDevDocs/Features/Tasks/`               | Prevents scope creep; each doc has clear purpose         |
...
**Plan (TempAppDevDocs/Features/Plans/):**
...
| 2   |`TempAppDevDocs/Features/Specs/\_template.md`                   | Add "Completeness Checklist" section at bottom with all required sections as checkboxes | ✅ DONE                         | Self-documenting spec validation                                        |
...
| 5   |`TempAppDevDocs/Features/Tasks/\_template.md`                   | Add`**Parallel:** [P] / blank`and`**Estimated:** 0.5h / 1h / 2h` fields | ✅ DONE | Enable parallelization, better planning |
...
| 13  |`TempAppDevDocs/Features/Plans/\_template.md`        | Add "Pre-Implementation Gates" section with checkboxes      | TODO    | Template enforcement                 |
