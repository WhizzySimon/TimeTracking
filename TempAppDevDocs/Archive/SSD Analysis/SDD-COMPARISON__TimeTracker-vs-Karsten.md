...
- `TempAppDevDocs/Features/Specs/_template.md` — 73 lines with Goal, Scope, FR, IG, DD, Edge cases, Data & privacy, Acceptance checks, Change log, Completeness checklist
- FR/IG/DD numbering: `TT-FR-001`, `TT-IG-001`, `TT-DD-001`

#### Task Decomposition

- `TempAppDevDocs/Features/Tasks/_template.md` — 38 lines with Files, Done when, Verify, Guardrails, Parallel marker, Estimated duration
...
- **No task templates** — no TempAppDevDocs/Features/Tasks/ folder
...
**Target:** `TempAppDevDocs/Features/Specs/_template.md`  
...
**Target:** `TempAppDevDocs/Features/Specs/_template.md` + `DevFramework/ToolSetup
Framework/DeveloperGuidesAndStandards
/IMPLEMENTATION_SPECIFICATION_RULES.md`  
...
1. ~~**Update `TempAppDevDocs/Features/Specs/_template.md`**~~ — DONE 2025-12-24: Added dependency declarations, "What we don't want" section, and timestamped changelog format
...
- **No TempAppDevDocs/Features/Tasks/ folder** — could not compare task decomposition
- **No DevFramework/ToolSetup
  Framework/FrameworkSelfImprovementLogs
