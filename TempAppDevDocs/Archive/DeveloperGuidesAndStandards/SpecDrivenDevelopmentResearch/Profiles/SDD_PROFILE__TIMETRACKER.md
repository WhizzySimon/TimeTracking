...
- `TempAppDevDocs/Features/Specs/_template.md` — Spec template with 10 sections
- `TempAppDevDocs/Features/Tasks/_template.md` — Task template with verification fields
...
| 10. Cost/time efficiency |           4 | Med        |`TempAppDevDocs/Features/Tasks/\_template.md:24`, `AGENTS.md:88` | Tasks sized 0.5-2h; parallel task marking; but no explicit token/cost tracking |
...
7. **Structured task template** — Files, Done when, Verify, Guardrails, Parallel, Estimated (`TempAppDevDocs/Features/Tasks/_template.md:11-24`)
...
1. **Add automated FR-to-test mapping** — Target: `TempAppDevDocs/Features/Specs/_template.md` add "Test file" column to acceptance checks
...
5. **Add spec versioning** — Target: `TempAppDevDocs/Features/Specs/_template.md` add "Version: 1.0.0" field
